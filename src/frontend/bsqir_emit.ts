...
class BSQIREmitter {
    ...
    private emitConditionalValueExpression(exp: ConditionalValueExpression): string {
        assert(false, "Not Implemented -- ConditionalValueExpression");
    }
    ...
    private emitExpression(exp: Expression): string {
        switch (exp.tag) {
            ...
            case ExpressionTag.ConditionalValueExpression: {
                return this.emitConditionalValueExpression(exp as ConditionalValueExpression);
            }
            default: {
