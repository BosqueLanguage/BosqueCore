...
class CPPEmitter {
    ...
    private emitAtomicStatement(stmt: IRAtomicStatement): string {
        ...
        if(ttag === IRStatementTag.IRNopStatement) {
            ...
            const invfunc = TransformCPPNameManager.generateNameForInvariantFunction(itdics.targetType.tkeystr);
