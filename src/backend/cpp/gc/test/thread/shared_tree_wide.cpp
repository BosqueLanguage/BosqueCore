...
__CoreCpp::Int sharedWideTreeTest_1()
{	
...
__CoreCpp::Int sharedWideTreeTest_2()
{	
	const size_t nroots = 2, nthds = 2;
	void* roots[nroots] = { 
		Main::accessNode(Main::makeTree(2_n, 0_n)),
		Main::accessNode(Main::makeTree(2_n, 0_n))
	};
	runThreadTest<nroots>(nthds, roots);
...
__CoreCpp::Int sharedWideTreeTestMulti_1()
{	
...
__CoreCpp::Int sharedWideTreeTestMulti_2()
{	
	const size_t nroots = 6, nthds = 2;
	void* roots[nroots] = { 
		Main::accessNode(Main::makeTree(2_n, 0_n)),
