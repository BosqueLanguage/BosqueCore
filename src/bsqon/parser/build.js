...
exec(`bison -d${mode === "debug" ? " -Wcex" : ""} bsqon.y && flex bsqon.l`, {cwd: srcdir}, (err, stdout, stderr) => {
    ...
    exec(`gcc -O1 -g -ggdb -fsanitize=address -fno-omit-frame-pointer -o ${outexec}/bsqon_parser bsqon_ast.c bsqon.tab.c lex.yy.c -lfl`, {cwd: srcdir}, (eerr, estdout, estderr) => {
        doneexport = true;
