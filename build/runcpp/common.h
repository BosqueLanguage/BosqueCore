...
namespace ᐸRuntimeᐳ
{
    ...
    consteval std::array<std::pair<uint8_t, const char*>, 95> s_escape_names_unicode = {
        std::make_pair<uint8_t, const char*>(0, "%NUL;"),
        std::make_pair<uint8_t, const char*>(1, "%SOH;"),
        std::make_pair<uint8_t, const char*>(2, "%STX;"),
        std::make_pair<uint8_t, const char*>(3, "%ETX;"),
        std::make_pair<uint8_t, const char*>(4, "%EOT;"),
        std::make_pair<uint8_t, const char*>(5, "%ENQ;"),
        std::make_pair<uint8_t, const char*>(6, "%ACK;"),
        std::make_pair<uint8_t, const char*>(7, "%a;"),
        std::make_pair<uint8_t, const char*>(8, "%b;"),
        std::make_pair<uint8_t, const char*>(9, "%t;"),
        std::make_pair<uint8_t, const char*>(10, "%n;"),
        std::make_pair<uint8_t, const char*>(11, "%v;"),
        std::make_pair<uint8_t, const char*>(12, "%f;"),
        std::make_pair<uint8_t, const char*>(13, "%r;"),
        std::make_pair<uint8_t, const char*>(14, "%SO;"),
        std::make_pair<uint8_t, const char*>(15, "%SI;"),
        std::make_pair<uint8_t, const char*>(16, "%DLE;"),
        std::make_pair<uint8_t, const char*>(17, "%DC1;"),
        std::make_pair<uint8_t, const char*>(18, "%DC2;"),
        std::make_pair<uint8_t, const char*>(19, "%DC3;"),
        std::make_pair<uint8_t, const char*>(20, "%DC4;"),
        std::make_pair<uint8_t, const char*>(21, "%NAK;"),
        std::make_pair<uint8_t, const char*>(22, "%SYN;"),
        std::make_pair<uint8_t, const char*>(23, "%ETB;"),
        std::make_pair<uint8_t, const char*>(24, "%CAN;"),
        std::make_pair<uint8_t, const char*>(25, "%EM;"),
        std::make_pair<uint8_t, const char*>(26, "%SUB;"),
        std::make_pair<uint8_t, const char*>(27, "%e;"),
        std::make_pair<uint8_t, const char*>(28, "%FS;"),
        std::make_pair<uint8_t, const char*>(29, "%GS;"),
        std::make_pair<uint8_t, const char*>(30, "%RS;"),
        std::make_pair<uint8_t, const char*>(31, "%US;"),
        std::make_pair<uint8_t, const char*>(127, "%DEL;"),

        std::make_pair<uint8_t, const char*>(32, "%space;"),
        std::make_pair<uint8_t, const char*>(33, "%bang;"),
        std::make_pair<uint8_t, const char*>(34, "%;"),
        ...
        std::make_pair<uint8_t, const char*>(59, "%semicolon;"),
    ...
    consteval std::array<std::pair<uint8_t, const char*>, 4> s_escape_names_unicode_simple = {
        std::make_pair<uint8_t, const char*>(9, "%t;"),
        std::make_pair<uint8_t, const char*>(10, "%n;"),
        std::make_pair<uint8_t, const char*>(34, "%;"),
        std::make_pair<uint8_t, const char*>(37, "%%;")
    ...
    consteval std::array<std::pair<uint8_t, const char*>, 55> s_escape_names_char = {
        std::make_pair<uint8_t, const char*>(9, "%t;"),
        std::make_pair<uint8_t, const char*>(10, "%n;"),
    ...
    consteval std::array<std::pair<uint8_t, const char*>, 55> s_escape_names_char_simple = {
        std::make_pair<uint8_t, const char*>(9, "%t;"),
        std::make_pair<uint8_t, const char*>(10, "%n;"),
        std::make_pair<uint8_t, const char*>(37, "%%;"),
        std::make_pair<uint8_t, const char*>(39, "%;")
    ...
    bool isSimpleEscapeCChar(char c)
    {
        return (c == 9 || c == 10 || c == 37 || c == 39);
    }

    bool isMustEscapeCChar(char c)
    {
