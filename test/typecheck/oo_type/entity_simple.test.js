...
describe ("Checker -- Entity Simple", () => {
    ...
    it("should check fail simple entity", function () {
        checkTestFunctionInFileError('entity Foo { f: Int; } function main(): Int { return Foo{3i}.g; }', "err1");

        checkTestFunctionInFileError('entity Foo { field f: Int; $f >= 0i; } function main(): Nat { return Foo{3i}.f; }', "err2");
        checkTestFunctionInFileError('entity Foo { field f: Int; $f >= 0n; } function main(): Nat { return Foo{3i}.f; }', "err3");
    });
});
...
describe ("Checker -- entity decl with default fields", () => {
    ...
    it("should check fail entity with default fields", function () {
        checkTestFunctionInFileError('entity Foo { f: Int = 3n; } function main(): Int { return Foo{3i}.f; }', "err4");

        checkTestFunctionInFileError('entity Foo { field f: Int; field g: Nat = $f; } function main(): Nat { return Foo{3n}.g; }', "err5");
    });
});
