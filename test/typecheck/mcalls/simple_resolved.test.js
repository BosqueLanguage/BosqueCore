...
describe ("Checker -- entity methods", () => {
    ...
    it("should check simple entity methods with type template", function () {
        checkTestFunction('entity Foo<T> { field f: T; method foo(x: T): T { if(true) { return x; } else { return this.f; } }} function main(): Int { let x = Foo<Int>{3i}; return x.foo(2i); }'); 
    });
    ...
    it("should check simple entity methods with both template and more", function () {
        checkTestFunction('entity Foo<T> { field f: T; method foo<U>(u: U): U { if (this.f)@<U> { return $_; } else { return u; } }} function main(): Nat { let x = Foo<Int>{3i}; return x.foo<Nat>(3n); }'); 
        checkTestFunction('entity Foo<T> { field f: T; method foo<U>(t: T): T { if (t)<U> { return t; } else { return this.f; } }} function main(): Int { let x = Foo<Int>{3i}; return x.foo<Int>(3i); }'); 
    });
    ...
    it("should check fail simple entity", function () {
        ...
        checkTestFunctionError('entity Foo<T> { field f: T; method foo<U>(t: T, u: U): U { if (this.f)@<U> { return $_; } else { return u; } }} function main(): Bool { let x = Foo<Int>{3i}; return x.foo<Nat>(3n); }', "Argument t expected type Int but got Nat"); 
    });

    it("should check simple entity methods multiple options", function () {
        checkTestFunction('entity Foo { field f: Int; method foo(): Int { return this.f; } method foo(out x: Int): Int { x = 3i; return x; } } function main(): Int { return Foo{3i}.foo(); }'); 
        checkTestFunction('entity Foo { field f: Int; method foo(): Int { return this.f; } method foo(out x: Int): Int { x = 3i; return x; } } function main(): Int { let x = Foo{3i}; var y: Int; return x.foo(out y); }');
        checkTestFunction('entity Foo { field f: Int; method foo(): Int { return this.f; } method foo(f: fn() -> Int): Int { return f(); } } function main(): Int { let x = Foo{3i}; return x.foo(fn() => 3i); }');
    });
});
...
describe ("Checker -- eADT methods", () => {
    ...
    it("should check simple eADT methods with type template", function () {
        checkTestFunction('datatype Foo<T> of Foo1 { field f: T; method foo(x: T): T { if(true) { return x; } else { return this.f; } }} ; function main(): Int { let x = Foo1<Int>{3i}; return x.foo(2i); }'); 
    });

    it("should check simple ROOT eADT methods", function () {
        checkTestFunction('datatype Foo of F1 { } F2 { } & { method foo(): Int { if(this)<F1> { return 1i; } else { return 0i; } } } function main(): Int { return F1{}.foo(); }'); 
    ...
    it("should check template ROOT eADT methods", function () {
        checkTestFunction('datatype Foo<T> of F1 { } F2 { } & { method foo(): Int { if(this)<F1<T>> { return  1i; } return 0i; } } function main(): Int { return F1<Bool>{}.foo(); }'); 
