...
describe ("Checker -- access field", () => {
    it("should check simple field access", function () {
    ...
    it("should check inherited field access", function () {
        checkTestFunction("concept Baz { field h: Bool; } entity Foo provides Baz { field f: Int; } function main(x: Foo): Int { return x.f; }");
        checkTestFunction("concept Baz { field h: Bool; } entity Foo provides Baz { field f: Int; } function main(x: Foo): Bool { return x.h; }");
    });
