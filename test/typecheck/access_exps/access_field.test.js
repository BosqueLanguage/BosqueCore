...
describe ("Checker -- access argument", () => {
    it("should check simple arg var access", function () {
        ...
        checkTestFunction("entity Bar { field h: Bool; } entity Foo { field f: Bar; } function main(x: Foo): Int { return x.f.h; }");
    });
    ...
    it("should fail simple wrong type", function () {
        ...
        checkTestFunctionError("entity Foo { field f: Int; } function main(x: Foo): Bool { return x.g; }", "err2");
    });
});
