...
describe ("CString -- append", () => {
    ...
    it("should concat", function () {
        ...
        runTestSet("public function main(z: CString): CString { return CString::concat(); }", [['"abc"', "''"]], []);
        runTestSet("public function main(z: CString): CString { return CString::concat(z); }", [['"abc"', "'abc'"], ['""', "''"]], []);
        runTestSet("public function main(z: CString): CString { return CString::concat(z, z); }", [['"abc"', "'abcabc'"], ['"x"', "'xx'"], ['""', "''"]], []);
        runTestSet("public function main(z: CString): CString { return CString::concat('abc', z, 'xyz'); }", [['""', "'abcxyz'"], ['"123"', "'abc123xyz'"]], []);
    });
    ...
    it("should join", function () {
        ...
        runTestSet("public function main(z: CString): CString { return CString::join('.'); }", [['"abc"', "''"]], []);
        runTestSet("public function main(z: CString): CString { return CString::join('.', z); }", [['"abc"', "'abc'"], ['""', "''"]], []);
        runTestSet("public function main(z: CString): CString { return CString::join('.', z, z); }", [['"abc"', "'abc.abc'"], ['"x"', "'x.x'"], ['""', "'.'"]], []);
        runTestSet("public function main(z: CString): CString { return CString::join('.', 'abc', z, 'xyz'); }", [['""', "'abc..xyz'"], ['"123"', "'abc.123.xyz'"]], []);

        runTestSet("public function main(z: CString): CString { return CString::join('', z); }", [], ['"abc"']);
    });
});
