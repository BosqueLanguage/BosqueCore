...
describe ("List -- push/insert", () => {
    ...
    it("should get pushBack w/ ref", function () {
        runTestSet('public function main(z: Int): List<Int> { var l = List<Int>{}; ref l.pushBack(3i); return l; }', [['1i', 'List<Int>{ 3i }']], []); 
        runTestSet('public function main(z: Int): List<Int> { var l = List<Int>{z, 1i}; ref l.pushBack(z + 5i); ref l.pushBack(z + 10i); return l; }', [['2i', 'List<Int>{ 2i, 1i, 7i, 12i }']], []);
    });
    ...
    it("should get pushFront w/ ref", function () {
        runTestSet('public function main(z: Int): List<Int> { var l = List<Int>{z}; ref l.pushFront(3i); return l; }', [['1i', 'List<Int>{ 3i, 1i }']], []); 
        runTestSet('public function main(z: Int): List<Int> { var l = List<Int>{1i, z}; ref l.pushFront(z + 5i); ref l.pushFront(z + 10i); return l; }', [['2i', 'List<Int>{ 12i, 7i, 1i, 2i }']], []); 
    });
    ...
    it("should get insert w/ ref", function () {
        runTestSet('public function main(i: Nat): List<Int> { var l = List<Int>{}; ref l.insert(i, 1i); return l; }', [['0n', 'List<Int>{ 1i }']], ['1n']); 
        runTestSet('public function main(i: Nat): List<Int> { var l = List<Int>{1i, 2i}; ref l.insert(i, 3i); return l; }', [['0n', 'List<Int>{ 3i, 1i, 2i }'], ['1n', 'List<Int>{ 1i, 3i, 2i }'], ['2n', 'List<Int>{ 1i, 2i, 3i }']], ['5n']); 
        runTestSet('public function main(i: Nat): List<Int> { var l = List<Int>{1i, 2i, 3i}; ref l.insert(i, 4i); return l; }', [['0n', 'List<Int>{ 4i, 1i, 2i, 3i }'], ['1n', 'List<Int>{ 1i, 4i, 2i, 3i }'], ['2n', 'List<Int>{ 1i, 2i, 4i, 3i }'], ['3n', 'List<Int>{ 1i, 2i, 3i, 4i }']], ['5n']); 
    });
