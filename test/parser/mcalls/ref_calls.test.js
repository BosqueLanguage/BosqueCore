...
describe ("Parser -- entity ref methods", () => {
    ...
    it("should parse simple entity methods w/ref args", function () {
        parseTestFunctionInFile('entity Foo { field f: Int; method foo(inout x: Int): Int { x = 5i; return this.f; }} [FUNC]', 'function main(): Int { let x = Foo{3i}; var y = 0i; return x.foo(inout y); }'); 
        parseTestFunctionInFile('entity Foo { field f: Int; method foo(out x: Int): Int { x = 5i; return this.f; }} [FUNC]', 'function main(): Int { let x = Foo{3i}; var y: Int; return x.foo(y); }'); 
    });
