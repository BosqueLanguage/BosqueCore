...
describe ("Parser -- simple declare only", () => {
    ...
    it("should fail declare only -- let/ref var", function () {
        parseTestFunctionError("function main(x: Int): Int { let y: Int; return 0i; }", "Cannot declare as let/ref without an assignment");
        parseTestFunctionError("function main(x: Int): Int { ref y: Int; return 0i; }", "Cannot declare as let/ref without an assignment");
    });
...
describe ("Parser -- simple declare-assign only", () => {
    it("should parse simple declare-assign", function () {
        ...
        parseTestFunction("function main(): Bool { ref x: Bool = true; return x; }", undefined);
        parseTestFunction("function main(): Bool { ref x = true; return x; }", undefined);
    });
    ...
    it("should fail declare-assign only -- bad name $", function () {
        ...
        parseTestFunctionError("function main(x: Int): Int { ref $y: Int = 1i; return 0i; }", "Invalid identifier name -- must start with a lowercase letter or _");
        parseTestFunctionError("function main(x: Int): Int { let $y: Int = 1i; return 0i; }", "Invalid identifier name -- must start with a lowercase letter or _");
    });

    it("should fail declare-assign only -- shadow", function () {
        parseTestFunctionError("function main(x: Int): Int { var x: Int = 3i; return 1i; }", "Variable x cannot be defined");
        parseTestFunctionError("function main(x: Int): Int { ref x: Int = 3i; return 1i; }", "Variable x cannot be defined");
    ...
    it("should fail simple no decl naked _", function () {
        parseTestFunctionError("function main(): Bool { var _ = 5i; return x; }", "Variable _ cannot be defined");
        parseTestFunctionError("function main(): Bool { ref _ = 5i; return x; }", "Variable _ cannot be defined");
