...
describe ("CPPEmit-- Type Alias Constructor", () => {
    it("should emit simple type alias", function () {
        runTestSet('type Foo = Int; public function main(x: Int): Foo { return 5i<Foo>; }', [['0i', '5i<Main::Foo>']], []);
...
describe ("CPPexec-- Type Alias w/ Invariant Constructor", () => {
    it("should exec type alias with invariant", function () {
        runTestSet('type Foo = Int & { invariant $value > 3i; } public function main(x: Int): Foo { return 5i<Foo>; }', [['4i', '5i<Main::Foo>']], []);
