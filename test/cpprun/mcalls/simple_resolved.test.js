...
describe ("CPPExec -- entity methods", () => {
    ...
    it("should exec simple entity methods multiple options", function () {
        runTestSet('entity Foo { field f: Int; method foo(): Int { return this.f; } method foo(out x: Int): Int { x = 3i; return x; } } public function main(z: Int): Int { let x = Foo{z}; var y: Int; let tt = x.foo(out y); return y + tt}', [['3i', '3i']], []);
...
describe ("CPPExec -- type alias methods", () => {
    it("should emit simple type alias methods", function () {
        ...
        runTestSet('type Foo = Int & { method foo<T>(): Bool { return this.value.?<T>; }} public function main(): Bool { let x = 3i<Foo>; return x.foo<Nat>(); }', [['3i', 'true']], []); 
    });
});
