...
describe ("CPPExec -- Postfix Chains", () => {
    it("should exec simple postfix chains", function () {
        runTestSet('entity Foo { field f: Int; } entity Bar { field g: Foo; } public function main(Bar b): Int { return b.g.f; }', [['Main::Bar{Main::Foo{3i}}', '3i']], []);
    ...
    it("should exec postfix chains w/ ref", function () {
        runTestSet('entity Foo { method f(inout x: Int): Int { x = x + 1i; return x; } } entity Bar { field g: Foo; } public function main(k: Int): Int { var y: Int = k; let vv = Bar{Foo{}}.g.f(inout y); assert(y == k + 1i) return vv + y; }', [['1i', '3i']], []); 
    });
});
