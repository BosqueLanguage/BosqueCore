...
describe ("CPPExec -- basic equals", () => {
    it("should exec compare simple types", function () {
        runTestSet("public function main(x: Nat): Bool { return x == 1n; }", [['1n', 'true'], ['0n', 'false'], ['10n', 'false']], []);
    ...
    it("should exec compare type alias", function () {
        runTestSet("type Foo = Int; public function main(x: Foo): Bool { return 0i<Foo> == x; }", [['2i<Main::Foo>', 'false'], ['0i<Main::Foo>', 'true'], ['-10i<Main::Foo>', 'false']], []);
    });
});

describe ("CPPExec -- basic !equal", () => {
    it("should exec compare simple types", function () {
        runTestSet("public function main(x: Nat): Bool { return x != 1n; }", [['1n', 'false'], ['0n', 'true'], ['10n', 'true']], []);
    ...
    it("should exec compare type alias", function () {
        runTestSet("type Foo = Int; public function main(x: Foo): Bool { return 0i<Foo> != x; }", [['2i<Main::Foo>', 'true'], ['0i<Main::Foo>', 'false'], ['-10i<Main::Foo>', 'true']], []);
    });
});
