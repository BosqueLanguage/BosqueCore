...
describe ("CPPEmit -- match Statement", () => {
    it("should emit simple match", function () {
        checkTestEmitMainFunction("public function main(): Int { let x: Option<Int> = some(3i); match(x) { None => { return 0i; } _ => { return 1i; } } }", 'Int Mainᕒmain() { OptionᐸIntᐳ x = OptionᐸIntᐳ::fromSome(&ᐸRuntimeᐳ::g_typeinfo_SomeᐸIntᐳ, SomeᐸIntᐳ{3_i}); switch(x.typeinfo->bsqtypeid) { case 0 /** None **/: { None ᑯx = none; return 0_i; } default: { SomeᐸIntᐳ ᑯx = x.asSome(); return 1_i; } } }');
