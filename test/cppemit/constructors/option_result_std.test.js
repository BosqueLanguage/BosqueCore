...
describe ("CPPEmit -- Regular Constructor Some", () => {
    it("should emit some/option return", function () {
        ...
        checkTestEmitMainFunction("public function main(): Option<Int> { return Some<Int>{3i}; }", 'OptionᐸIntᐳ Mainᕒmain() { return OptionᐸIntᐳ{SomeᐸIntᐳ{3_i}}; }');
    });
});
...
describe ("CPPEmit -- Regular Constructor Option", () => {
    it("should emit none/option return", function () {
        ...
        checkTestEmitMainFunction("public function main(): Option<Int> { let x = Some<Int>{3i}; return x; }", 'OptionᐸIntᐳ Mainᕒmain() { SomeᐸIntᐳ x = SomeᐸIntᐳ{3_i}; return OptionᐸIntᐳ{x}; }');
    });
});
