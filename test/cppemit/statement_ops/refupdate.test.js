...
describe ("CPPEmit -- ref updates", () => {
    ...
    it("should emit ref updates direct with invariants", function () {
        ...
        checkTestEmitMainFunction('concept Bar { field g: Bool; invariant $g; } entity Foo provides Bar { field x: Int; } public function main(x: Int): Bool { var z = Foo{true, x}; ref z[g = z.x != 0i]; return z.g; }', 'Bool Mainᕒmain(Int x) { ᐸRuntimeᐳ::bsq_invariant((bool)(MainᕒBarᐤinvariant_0(TRUE)), "test.bsq", 2, nullptr, "Failed Invariant"); MainᕒFoo z = MainᕒFoo{TRUE, x}; { Bool ᑯg = z.g; Bool tmp_0 = z.x != 0_i; Int tmp_1 = z.x; ᐸRuntimeᐳ::bsq_invariant((bool)(MainᕒBarᐤinvariant_0(tmp_0)), "test.bsq", 2, nullptr, "Failed Invariant"); z = {tmp_0, tmp_1}; } return z.g; }');
    });
