...
describe ("CPPEmit -- elist decl and access", () => {
    it("should emit simple elist", function () {
        ...
        checkTestEmitMainFunction('public function main(): Bool { return (|2i, true|).1; }', 'bbb'); 

        checkTestEmitMainFunction('public function main(): Bool { let x = (|2i, true|); return x.1; }', 'ccc'); 

        checkTestEmitMainFunction('public function main(): (|Int, Bool|) { return (|2i, true|); }', 'ddd'); 
        checkTestEmitMainFunction('public function main(x: (|Int, Bool|)): Int { return 1i + x.0; }', 'eee'); 
    });
    ...
    it("should emit nesting", function () {
        ...
        checkTestEmitMainFunction('entity Foo { field pp: (|Int, Bool|); } public function main(): Foo { return Foo{(|2i, false|)}; }', 'yyy'); 
    });
});
