...
describe ("CPPEmit -- eADT decl", () => {
    ...
    it.skip("should check eADT function", function () {
        checkTestEmitMainFunction('datatype Foo of F1 { field f: Int; } F2 { } & { function foo(): Int { return 3i; } } public function main(): Int { return F1::foo(); }', 'ppp'); 
        checkTestEmitMainFunction('datatype Foo of F1 { field f: Int; } F2 { } & { function foo(): Int { return 3i; } } public function main(): Int { return Foo::foo(); }', 'qqq'); 
    });
});
