...
describe ("CPP Emit Evaluate -- Map set", () => {
    it("should set key", function () {
        runMainCode('public function main(): Nat { return Map<Int, Int>{1i => 0i}.set(1i, 2i).size(); }', "1_n"); 

        runMainCode('public function main(): Int { return Map<Int, Int>{1i => 0i}.set(1i, 2i).get(1i); }', "2_i"); 
        runMainCode('public function main(): Int { return Map<Int, Int>{1i => 0i, 3i => 5i}.set(3i, 1i).get(3i); }', "1_i");
        runMainCode('public function main(): Int { return Map<Int, Int>{1i => 0i, 3i => 5i}.set(1i, 4i).get(1i); }', "4_i");
    });
