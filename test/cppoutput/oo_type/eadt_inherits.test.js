...
describe ("CPP Emit Evaluate -- entity decl inherits", () => {
    it("should exec simple inherits eADT", function () {
        runMainCode('datatype Foo using { field f: Int; } of | F1 { } | F2 { }; public function main(): Int { return F1{3i}.f; }', "3_i"); 
//        runMainCode('datatype Foo using { field f: Int; invariant $f >= 0i; } of F1 { } | F2 { field g: Bool; }; public function main(): Bool { return F2{3i, false}.g; }', "false"); 
        ...
        runMainCode('datatype Foo<T> using { field f: T; } of | F1 { } | F2 { }; public function main(): Int { return F1<Int>{3i}.f; }', "3_i"); 
