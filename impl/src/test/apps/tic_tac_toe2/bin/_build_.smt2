...
(declare-datatypes (
    ...
    ( 
      ...
      (TypeTag_TickTime)
      (TypeTag_UUID)
      (TypeTag__cells._List_Main..PlayerMark__)
    )
))
...
(declare-datatypes (
    (bsq_regex 0)
    ;;NO DATA;;
    (_cells._List_Main..PlayerMark__ 0)
    (ListOps 0)
    (Main..Board 0)
    (Main..BoardPostion 0)
    ...
    ;;NO DATA;;
    ( (_cells._List_Main..PlayerMark__@cons (_cells._List_Main..PlayerMark__@_cells List_Main..PlayerMark_)) )
    ( (ListOps@cons ) )
    ( (Main..Board@cons (Main..Board@_cells List_Main..PlayerMark_)) )
    ...
    (
      ...
      ;;NO DATA;;
      (_cells._List_Main..PlayerMark__@box (bsqobject__cells._List_Main..PlayerMark___value _cells._List_Main..PlayerMark__))
...
(declare-datatypes (
      ($Result__cells._List_Main..PlayerMark__ 0)
      ($Result_BTerm 0)
      ($Result_BBigInt 0)
      ($Result_BBigNat 0)
      ($Result_Bool 0)
    ...
    ( ($Result__cells._List_Main..PlayerMark__@success ($Result__cells._List_Main..PlayerMark__@success_value _cells._List_Main..PlayerMark__)) ($Result__cells._List_Main..PlayerMark__@error ($Result__cells._List_Main..PlayerMark__@error_value ErrorID)) )
...
(define-fun $ListSingletonCons_9_List_Main..PlayerMark_ ((arg0 Main..PlayerMark) (arg1 Main..PlayerMark) (arg2 Main..PlayerMark) (arg3 Main..PlayerMark) (arg4 Main..PlayerMark) (arg5 Main..PlayerMark) (arg6 Main..PlayerMark) (arg7 Main..PlayerMark) (arg8 Main..PlayerMark)) List_Main..PlayerMark_
(List_Main..PlayerMark_@cons (seq.++ (seq.unit arg0) (seq.unit arg1) (seq.unit arg2) (seq.unit arg3) (seq.unit arg4) (seq.unit arg5) (seq.unit arg6) (seq.unit arg7) (seq.unit arg8)))
)

(define-fun Main..Board..create4 () _cells._List_Main..PlayerMark__
(let ((@tmp_1 ($ListSingletonCons_9_List_Main..PlayerMark_ Main..PlayerMark..x Main..PlayerMark..x Main..PlayerMark..empty Main..PlayerMark..o Main..PlayerMark..o Main..PlayerMark..empty Main..PlayerMark..empty Main..PlayerMark..empty Main..PlayerMark..empty)))
    (let ((@tmp_0 (_cells._List_Main..PlayerMark__@cons @tmp_1)))
...
(define-fun tictactoe.bsq_k13_invariant@0..45@1336..invariant@0 (($cells List_Main..PlayerMark_)) Bool
(let ((@tmp_3 (List_Main..PlayerMark_..size_T_Main..PlayerMark_ $cells)))
    (let ((@tmp_0 (= @tmp_3 9)))
      (let (($__ir_ret__ @tmp_0))
        (let (($return $__ir_ret__))
          $return
...
(define-fun Main..Board..@@constructor (($cells List_Main..PlayerMark_)) $Result_Main..Board
(let ((@tmp_0 (tictactoe.bsq_k13_invariant@0..45@1336..invariant@0 $cells)))
    (ite @tmp_0
...
(let ((@tmp_3 (Main..Board@_cells this)))
    (let ((@tmp_10 (Main..BoardPostion@_rowpos c)))
      (let ((@tmp_6 (* 3 @tmp_10)))
        (let ((@tmp_13 (Main..BoardPostion@_colpos c)))
          (let ((@tmp_5 (+ @tmp_6 @tmp_13)))
            (let ((_@tmpvar@9 (List_Main..PlayerMark_..get_T_Main..PlayerMark_ @tmp_3 @tmp_5)))
              (ite ((_ is $Result_Main..PlayerMark@error) _@tmpvar@9)
                ($Result_Bool@error ($Result_Main..PlayerMark@error_value _@tmpvar@9))
                (let ((@tmp_4 ($Result_Main..PlayerMark@success_value _@tmpvar@9)))
                  (let ((@tmp_0 (= @tmp_4 Main..PlayerMark..empty)))
                    (let (($__ir_ret__ @tmp_0))
                      (let (($return $__ir_ret__))
...
(define-fun tictactoe.bsq_k13_pre@0..77@2346..pre@0 ((this Main..Board) (c Main..BoardPostion) (mark Main..PlayerMark)) $Result_Bool
(let ((_@tmpvar@10 (Main..Board..isCellEmpty this c)))
    (ite ((_ is $Result_Bool@error) _@tmpvar@10)
      _@tmpvar@10
      (let ((@tmp_2 ($Result_Bool@success_value _@tmpvar@10)))
...
(let ((_@tmpvar@13 (tictactoe.bsq_k13_pre@0..77@2346..pre@0 this c mark)))
    (ite ((_ is $Result_Bool@error) _@tmpvar@13)
      ($Result_Main..Board@error ($Result_Bool@error_value _@tmpvar@13))
      (let ((@tmp_0 ($Result_Bool@success_value _@tmpvar@13)))
        (ite @tmp_0
          (let ((@tmp_5 (Main..Board@_cells this)))
            (let (($cells_@2453 @tmp_5))
              (let ((@tmp_13 (Main..BoardPostion@_rowpos c)))
                (let ((@tmp_9 (* 3 @tmp_13)))
                  (let ((@tmp_16 (Main..BoardPostion@_colpos c)))
                    (let ((@tmp_8 (+ @tmp_9 @tmp_16)))
                      (let ((_@tmpvar@12 (List_Main..PlayerMark_..set_T_Main..PlayerMark_ @tmp_5 @tmp_8 mark)))
                        (ite ((_ is $Result_List_Main..PlayerMark_@error) _@tmpvar@12)
                          ($Result_Main..Board@error ($Result_List_Main..PlayerMark_@error_value _@tmpvar@12))
                          (let ((@tmp_7 ($Result_List_Main..PlayerMark_@success_value _@tmpvar@12)))
                            (let ((_@tmpvar@11 (Main..Board..@@constructor @tmp_7)))
                              (ite ((_ is $Result_Main..Board@error) _@tmpvar@11)
                                _@tmpvar@11
                                (let ((@tmp_3 ($Result_Main..Board@success_value _@tmpvar@11)))
                                  (let (($__ir_ret__ @tmp_3))
                                    (let (($return $__ir_ret__))
                                      ($Result_Main..Board@success $return)
                                    )
...
(let ((@tmp_2 (Main..Board@_cells this)))
    (let ((@tmp_9 (Main..BoardPostion@_rowpos c)))
      (let ((@tmp_5 (* 3 @tmp_9)))
        (let ((@tmp_12 (Main..BoardPostion@_colpos c)))
          (let ((@tmp_4 (+ @tmp_5 @tmp_12)))
            (let ((_@tmpvar@14 (List_Main..PlayerMark_..get_T_Main..PlayerMark_ @tmp_2 @tmp_4)))
              (ite ((_ is $Result_Main..PlayerMark@error) _@tmpvar@14)
                _@tmpvar@14
                (let ((@tmp_3 ($Result_Main..PlayerMark@success_value _@tmpvar@14)))
                  (let (($__ir_ret__ @tmp_3))
                    (let (($return $__ir_ret__))
                      ($Result_Main..PlayerMark@success $return)
                    )
...
(let ((_@tmpvar@17 (Main..Board..getCellMark this c1)))
    (ite ((_ is $Result_Main..PlayerMark@error) _@tmpvar@17)
      ($Result_Bool@error ($Result_Main..PlayerMark@error_value _@tmpvar@17))
      (let ((@tmp_4 ($Result_Main..PlayerMark@success_value _@tmpvar@17)))
        (let ((@tmp_1 (= @tmp_4 player)))
          (let ((@tmp_0 @tmp_1))
            (ite @tmp_1
              (let ((_@tmpvar@16 (Main..Board..getCellMark this c2)))
                (ite ((_ is $Result_Main..PlayerMark@error) _@tmpvar@16)
                  ($Result_Bool@error ($Result_Main..PlayerMark@error_value _@tmpvar@16))
                  (let ((@tmp_11 ($Result_Main..PlayerMark@success_value _@tmpvar@16)))
                    (let ((@tmp_8 (= @tmp_11 player)))
                      (let ((@tmp_7 @tmp_8))
                        (ite @tmp_8
                          (let ((_@tmpvar@15 (Main..Board..getCellMark this c3)))
                            (ite ((_ is $Result_Main..PlayerMark@error) _@tmpvar@15)
                              ($Result_Bool@error ($Result_Main..PlayerMark@error_value _@tmpvar@15))
                              (let ((@tmp_17 ($Result_Main..PlayerMark@success_value _@tmpvar@15)))
...
(ite @tmp_24
    ...
    (let ((_@tmpvar@19 (Main..Board..check3 this Main..BoardPostion..r0c0 Main..BoardPostion..r1c1 Main..BoardPostion..r2c2 player)))
      (ite ((_ is $Result_Bool@error) _@tmpvar@19)
        _@tmpvar@19
        (let ((@tmp_51 ($Result_Bool@success_value _@tmpvar@19)))
          (let ((@tmp_48 @tmp_51))
            (ite @tmp_51
              ...
              (let ((_@tmpvar@18 (Main..Board..check3 this Main..BoardPostion..r0c2 Main..BoardPostion..r1c1 Main..BoardPostion..r2c0 player)))
                (ite ((_ is $Result_Bool@error) _@tmpvar@18)
                  _@tmpvar@18
                  (let ((@tmp_58 ($Result_Bool@success_value _@tmpvar@18)))
                    (let ((@tmp_48$1 @tmp_58))
...
(let ((@tmp_24 @tmp_32))
    (let ((_@tmpvar@20 (__i__Main..Board..checkWinner$Llogic_or_done_11 @tmp_24 player this)))
      (ite ((_ is $Result_Bool@error) _@tmpvar@20)
        _@tmpvar@20
        (let (($__ir_ret__ ($Result_Bool@success_value _@tmpvar@20)))
          (let (($return $__ir_ret__))
            ($Result_Bool@success $return)
          )
        )
...
(ite @tmp_0
    ...
    (let ((_@tmpvar@26 (Main..Board..check3 this Main..BoardPostion..r0c0 Main..BoardPostion..r1c0 Main..BoardPostion..r2c0 player)))
      (ite ((_ is $Result_Bool@error) _@tmpvar@26)
        _@tmpvar@26
        (let ((@tmp_27 ($Result_Bool@success_value _@tmpvar@26)))
          (let ((@tmp_24 @tmp_27))
            (ite @tmp_27
              (let ((_@tmpvar@25 (__i__Main..Board..checkWinner$Llogic_or_done_11 @tmp_24 player this)))
                (ite ((_ is $Result_Bool@error) _@tmpvar@25)
                  _@tmpvar@25
                  (let (($__ir_ret__$2 ($Result_Bool@success_value _@tmpvar@25)))
              ...
              (let ((_@tmpvar@24 (Main..Board..check3 this Main..BoardPostion..r0c1 Main..BoardPostion..r1c1 Main..BoardPostion..r2c1 player)))
                (ite ((_ is $Result_Bool@error) _@tmpvar@24)
                  _@tmpvar@24
                  (let ((@tmp_35 ($Result_Bool@success_value _@tmpvar@24)))
                    (let ((@tmp_32 @tmp_35))
                      (ite @tmp_35
                        (let ((_@tmpvar@23 (__i__Main..Board..checkWinner$Llogic_or_done_13 @tmp_32 player this)))
                          (ite ((_ is $Result_Bool@error) _@tmpvar@23)
                            _@tmpvar@23
                            (let (($__ir_ret__$1 ($Result_Bool@success_value _@tmpvar@23)))
                        ...
                        (let ((_@tmpvar@22 (Main..Board..check3 this Main..BoardPostion..r0c2 Main..BoardPostion..r1c2 Main..BoardPostion..r2c2 player)))
                          (ite ((_ is $Result_Bool@error) _@tmpvar@22)
                            _@tmpvar@22
                            (let ((@tmp_42 ($Result_Bool@success_value _@tmpvar@22)))
                              (let ((@tmp_32$1 @tmp_42))
                                (let ((_@tmpvar@21 (__i__Main..Board..checkWinner$Llogic_or_done_13 @tmp_32$1 player this)))
                                  (ite ((_ is $Result_Bool@error) _@tmpvar@21)
                                    _@tmpvar@21
                                    (let (($__ir_ret__ ($Result_Bool@success_value _@tmpvar@21)))
...
(let ((@tmp_0 @tmp_8))
    (let ((_@tmpvar@27 (__i__Main..Board..checkWinner$Llogic_or_done_4 @tmp_0 player this)))
      (ite ((_ is $Result_Bool@error) _@tmpvar@27)
        _@tmpvar@27
        (let (($__ir_ret__ ($Result_Bool@success_value _@tmpvar@27)))
          (let (($return $__ir_ret__))
            ($Result_Bool@success $return)
          )
        )
...
(let ((_@tmpvar@33 (Main..Board..check3 this Main..BoardPostion..r0c0 Main..BoardPostion..r0c1 Main..BoardPostion..r0c2 player)))
    (ite ((_ is $Result_Bool@error) _@tmpvar@33)
      _@tmpvar@33
      (let ((@tmp_3 ($Result_Bool@success_value _@tmpvar@33)))
        (let ((@tmp_0 @tmp_3))
          (ite @tmp_3
            (let ((_@tmpvar@30 (__i__Main..Board..checkWinner$Llogic_or_done_4 @tmp_0 player this)))
              (ite ((_ is $Result_Bool@error) _@tmpvar@30)
                _@tmpvar@30
                (let (($__ir_ret__$2 ($Result_Bool@success_value _@tmpvar@30)))
                  (let (($__ir_ret__$3 $__ir_ret__$2))
                    (let (($return $__ir_ret__$3))
                      ($Result_Bool@success $return)
                    )
            ...
            (let ((_@tmpvar@32 (Main..Board..check3 this Main..BoardPostion..r1c0 Main..BoardPostion..r1c1 Main..BoardPostion..r1c2 player)))
              (ite ((_ is $Result_Bool@error) _@tmpvar@32)
                _@tmpvar@32
                (let ((@tmp_11 ($Result_Bool@success_value _@tmpvar@32)))
                  (let ((@tmp_8 @tmp_11))
                    (ite @tmp_11
                      (let ((_@tmpvar@31 (__i__Main..Board..checkWinner$Llogic_or_done_6 @tmp_8 player this)))
                        (ite ((_ is $Result_Bool@error) _@tmpvar@31)
                          _@tmpvar@31
                          (let (($__ir_ret__$1 ($Result_Bool@success_value _@tmpvar@31)))
                            (let (($__ir_ret__$3 $__ir_ret__$1))
                              (let (($return $__ir_ret__$3))
                                ($Result_Bool@success $return)
                              )
                      ...
                      (let ((_@tmpvar@29 (Main..Board..check3 this Main..BoardPostion..r2c0 Main..BoardPostion..r2c1 Main..BoardPostion..r2c2 player)))
                        (ite ((_ is $Result_Bool@error) _@tmpvar@29)
                          _@tmpvar@29
                          (let ((@tmp_18 ($Result_Bool@success_value _@tmpvar@29)))
                            (let ((@tmp_8$1 @tmp_18))
                              (let ((_@tmpvar@28 (__i__Main..Board..checkWinner$Llogic_or_done_6 @tmp_8$1 player this)))
                                (ite ((_ is $Result_Bool@error) _@tmpvar@28)
                                  _@tmpvar@28
                                  (let (($__ir_ret__ ($Result_Bool@success_value _@tmpvar@28)))
                                    (let (($__ir_ret__$3 $__ir_ret__))
                                      (let (($return $__ir_ret__$3))
                                        ($Result_Bool@success $return)
                                      )
...
(let ((@tmp_1 Main..Board..create4))
    (let ((@tmp_2 (_cells._List_Main..PlayerMark__@_cells @tmp_1)))
      (let ((_@tmpvar@36 (Main..Board..@@constructor @tmp_2)))
        (ite ((_ is $Result_Main..Board@error) _@tmpvar@36)
          ($Result_Bool@error ($Result_Main..Board@error_value _@tmpvar@36))
          (let ((@tmp_0 ($Result_Main..Board@success_value _@tmpvar@36)))
            (let ((bb @tmp_0))
              (let ((_@tmpvar@35 (Main..Board..setCellMark @tmp_0 c Main..PlayerMark..x)))
                (ite ((_ is $Result_Main..Board@error) _@tmpvar@35)
                  ($Result_Bool@error ($Result_Main..Board@error_value _@tmpvar@35))
                  (let ((@tmp_5 ($Result_Main..Board@success_value _@tmpvar@35)))
                    (let ((nb @tmp_5))
                      (let ((_@tmpvar@34 (Main..Board..checkWinner @tmp_5 Main..PlayerMark..x)))
                        (ite ((_ is $Result_Bool@error) _@tmpvar@34)
                          _@tmpvar@34
                          (let ((@tmp_11 ($Result_Bool@success_value _@tmpvar@34)))
...
(define-fun tictactoe.bsq_k13_invariant@0..25@670..invariant@0 (($rowpos BNat)) Bool
(let ((@tmp_0 (< $rowpos 3)))
    (let (($__ir_ret__ @tmp_0))
      (let (($return $__ir_ret__))
        $return
...
(define-fun tictactoe.bsq_k13_invariant@1..26@698..invariant@1 (($colpos BNat)) Bool
(let ((@tmp_0 (< $colpos 3)))
    (let (($__ir_ret__ @tmp_0))
      (let (($return $__ir_ret__))
        $return
...
(let ((@tmp_0 (tictactoe.bsq_k13_invariant@0..25@670..invariant@0 $rowpos)))
    (let ((@tmp_1 (tictactoe.bsq_k13_invariant@1..26@698..invariant@1 $colpos)))
...
(let ((_@tmpvar@37 (_@@cons_Nat_entrypoint (seq.++ (seq.++ path (seq.unit 0)) (seq.unit 0)))) (_@tmpvar@38 (_@@cons_Nat_entrypoint (seq.++ (seq.++ path (seq.unit 0)) (seq.unit 1)))))
    (ite (and ((_ is $Result_BNat@success) _@tmpvar@37) ((_ is $Result_BNat@success) _@tmpvar@38) (Main..BoardPostion..@@validateinput ($Result_BNat@success_value _@tmpvar@37) ($Result_BNat@success_value _@tmpvar@38)))
      (Main..BoardPostion..@@constructor ($Result_BNat@success_value _@tmpvar@37) ($Result_BNat@success_value _@tmpvar@38))
      ($Result_Main..BoardPostion@error ErrorID_AssumeCheck)
    )
  )
)

(define-fun constexp_tictactoe.bsq_k13_constexp..28@756..r0c0 () $Result_Main..BoardPostion
...
(define-fun constexp_tictactoe.bsq_k13_constexp..29@807..r0c1 () $Result_Main..BoardPostion
...
(define-fun constexp_tictactoe.bsq_k13_constexp..30@858..r0c2 () $Result_Main..BoardPostion
...
(define-fun constexp_tictactoe.bsq_k13_constexp..32@914..r1c0 () $Result_Main..BoardPostion
...
(define-fun constexp_tictactoe.bsq_k13_constexp..33@965..r1c1 () $Result_Main..BoardPostion
...
(define-fun constexp_tictactoe.bsq_k13_constexp..34@1016..r1c2 () $Result_Main..BoardPostion
...
(define-fun constexp_tictactoe.bsq_k13_constexp..36@1068..r2c0 () $Result_Main..BoardPostion
...
(define-fun constexp_tictactoe.bsq_k13_constexp..37@1119..r2c1 () $Result_Main..BoardPostion
...
(define-fun constexp_tictactoe.bsq_k13_constexp..38@1170..r2c2 () $Result_Main..BoardPostion
...
(assert ((_ is $Result_Main..BoardPostion@success) constexp_tictactoe.bsq_k13_constexp..28@756..r0c0)) (assert (= Main..BoardPostion..r0c0 ($Result_Main..BoardPostion@success_value constexp_tictactoe.bsq_k13_constexp..28@756..r0c0)))
(assert ((_ is $Result_Main..BoardPostion@success) constexp_tictactoe.bsq_k13_constexp..29@807..r0c1)) (assert (= Main..BoardPostion..r0c1 ($Result_Main..BoardPostion@success_value constexp_tictactoe.bsq_k13_constexp..29@807..r0c1)))
(assert ((_ is $Result_Main..BoardPostion@success) constexp_tictactoe.bsq_k13_constexp..30@858..r0c2)) (assert (= Main..BoardPostion..r0c2 ($Result_Main..BoardPostion@success_value constexp_tictactoe.bsq_k13_constexp..30@858..r0c2)))
(assert ((_ is $Result_Main..BoardPostion@success) constexp_tictactoe.bsq_k13_constexp..32@914..r1c0)) (assert (= Main..BoardPostion..r1c0 ($Result_Main..BoardPostion@success_value constexp_tictactoe.bsq_k13_constexp..32@914..r1c0)))
(assert ((_ is $Result_Main..BoardPostion@success) constexp_tictactoe.bsq_k13_constexp..33@965..r1c1)) (assert (= Main..BoardPostion..r1c1 ($Result_Main..BoardPostion@success_value constexp_tictactoe.bsq_k13_constexp..33@965..r1c1)))
(assert ((_ is $Result_Main..BoardPostion@success) constexp_tictactoe.bsq_k13_constexp..34@1016..r1c2)) (assert (= Main..BoardPostion..r1c2 ($Result_Main..BoardPostion@success_value constexp_tictactoe.bsq_k13_constexp..34@1016..r1c2)))
(assert ((_ is $Result_Main..BoardPostion@success) constexp_tictactoe.bsq_k13_constexp..36@1068..r2c0)) (assert (= Main..BoardPostion..r2c0 ($Result_Main..BoardPostion@success_value constexp_tictactoe.bsq_k13_constexp..36@1068..r2c0)))
(assert ((_ is $Result_Main..BoardPostion@success) constexp_tictactoe.bsq_k13_constexp..37@1119..r2c1)) (assert (= Main..BoardPostion..r2c1 ($Result_Main..BoardPostion@success_value constexp_tictactoe.bsq_k13_constexp..37@1119..r2c1)))
(assert ((_ is $Result_Main..BoardPostion@success) constexp_tictactoe.bsq_k13_constexp..38@1170..r2c2)) (assert (= Main..BoardPostion..r2c2 ($Result_Main..BoardPostion@success_value constexp_tictactoe.bsq_k13_constexp..38@1170..r2c2)))
